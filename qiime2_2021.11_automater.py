...
usage = 'python qiime2_2021.11_automater.py otu_table_fp metadata_fp taxonomy_fp rarefaction_level_counts phylo_tree_OR_NONE PROK_OR_NONE'

## Refactored for QIIME 2021.11 changes ##
## Not all features compatible with previous versions ##
...
if phylo_go:  # Do the phylogenetic core metrics
    ...
    alphas = ['evenness_vector.qza','faith_pd_vector.qza','observed_features_vector.qza','shannon_vector.qza']
    ...
    newalphas = ['evenness_vector.txt','faith_pd_vector.txt','observed_features_vector.txt','shannon_vector.txt']
    with open('alpha_diversity/evenness_vector.txt', 'r') as ev_in, open('alpha_diversity/faith_pd_vector.txt', 'r') as pd_in, open('alpha_diversity/observed_features_vector.txt', 'r') as ob_in, open('alpha_diversity/shannon_vector.txt', 'r') as sh_in:
    ...
    alphas = ['evenness_vector.qza','observed_features_vector.qza','shannon_vector.qza']
    ...
    combined_alpha = os.path.join('alpha_diversity','alphadiv.txt')
    newalphas = ['evenness_vector.txt','faith_pd_vector.txt','observed_features_vector.txt','shannon_vector.txt']
    with open('alpha_diversity/evenness_vector.txt', 'r') as ev_in, open('alpha_diversity/observed_features_vector.txt', 'r') as ob_in, open('alpha_diversity/shannon_vector.txt', 'r') as sh_in:
